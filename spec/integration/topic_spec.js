...
describe("routes: topics", () => {
    ...
    beforeEach((done) => {
        ...
        sequelize.sync({
            ...
            Topic.create({
                    title: "I Am A Topic",
                    description: "There are lot of them"
                })
                .then((topic) => {
                    this.topic = topic;
                    done();
    ...
    describe("GET /topics", () => {
        it("should return a status code 200 and all topics", (done) => {
            request.get(base, (err, res, body) => {
                ...
                expect(body).toContain("I Am A Topic");
                done();
            });
        });
    });
    ...
    describe("POST /topics/create", () => {
        const options = {
            url: `${base}create`,
            form: {
                title: "Create Topics Test Title",
    ...
    describe("POST /topics/:id/update", () => {
        it("should update the topic with the given values", (done) => {
            const options = {
                ...
                form: {
                    title: "Update Topics Test Title",
                    description: "Update topics test description"
                }
            };
            request.post(options, (err, res, body) => {
                ...
                Topic.findOne({
                    ...
                    .then((topic) => {
                        expect(topic.title).toBe("Update Topics Test Title");
                        done();
                    });
            });
        });
